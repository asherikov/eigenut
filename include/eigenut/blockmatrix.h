...
#ifndef H_EIGENUT_BLOCKMATRIX
#define H_EIGENUT_BLOCKMATRIX
...
namespace eigenut
{
#define EIGENUT_CODE_GENERATOR(ClassName, MatrixType) \
        template<   int t_block_rows_num, \
                    int t_block_cols_num, \
                    MatrixSparsityType::Type t_sparsity_type> \
            class EIGENUT_VISIBILITY_ATTRIBUTE ClassName : \
     ...
     */
    EIGENUT_CODE_GENERATOR(ConstBlockMatrixInterface, const DefaultDynamicMatrix &)

    /// @copydoc ConstBlockMatrixInterface
    EIGENUT_CODE_GENERATOR(BlockMatrixInterface, DefaultDynamicMatrix &)
...
#define EIGENUT_CODE_GENERATOR(class_name, sparsity_type) \
        template<   int t_block_rows_num,\
                    int t_block_cols_num>\
            class EIGENUT_VISIBILITY_ATTRIBUTE class_name \
     ...
     * @tparam t_block_cols_num number of columns in one block
     */
    EIGENUT_CODE_GENERATOR(GenericBlockKroneckerProduct, MatrixSparsityType::NONE)
    /// @copydoc GenericBlockMatrix
    EIGENUT_CODE_GENERATOR(DiagonalBlockKroneckerProduct, MatrixSparsityType::DIAGONAL)
    /// @copydoc GenericBlockMatrix
    EIGENUT_CODE_GENERATOR(LeftLowerTriangularBlockKroneckerProduct, MatrixSparsityType::LEFT_LOWER_TRIANGULAR)
#undef EIGENUT_CODE_GENERATOR
...
#define EIGENUT_PARENT_CLASS_SHORTHAND BlockMatrixBase<  const Eigen::Map<   const EIGENUT_DYNAMIC_MATRIX(t_Scalar),\
                                                                                t_alignment, \
                                                                                t_Stride >, \
    ...
    template<   typename t_Scalar,
                ...
                int t_block_cols_num,
                MatrixSparsityType::Type t_sparsity_type>
        class EIGENUT_VISIBILITY_ATTRIBUTE BlockMatrixMap : public EIGENUT_PARENT_CLASS_SHORTHAND
    {
        protected:
        ...
        public:
            ...
            EIGENUT_DEFINE_BLOCK_MATRIX_CONSTRUCTORS(BlockMatrixMap)
            ...
            BlockKroneckerProductBase<
                                const Eigen::Map<   const EIGENUT_DYNAMIC_MATRIX(t_Scalar),
                                                    t_alignment,
                                                    t_Stride >,
                                t_block_rows_num,
                                t_block_cols_num,
...
#define EIGENUT_PARENT_CLASS_SHORTHAND BlockMatrixBase<DefaultDynamicMatrix, t_block_rows_num, t_block_cols_num, t_sparsity_type>
    /**
    ...
    template<   int t_block_rows_num,
                int t_block_cols_num,
                MatrixSparsityType::Type t_sparsity_type>
    class EIGENUT_VISIBILITY_ATTRIBUTE BlockMatrix : public EIGENUT_PARENT_CLASS_SHORTHAND
    {
        protected:
            using EIGENUT_PARENT_CLASS_SHORTHAND::matrix_;
            using EIGENUT_PARENT_CLASS_SHORTHAND::block_rows_num_;
        ...
        public:
            ...
            EIGENUT_DEFINE_BLOCK_MATRIX_CONSTRUCTORS(BlockMatrix)
            ...
            {
                return (SelectionMap(eigenut::selectRows(matrix_,
...
#define EIGENUT_CODE_GENERATOR(class_name, sparsity_type) \
        template<   int t_block_rows_num,\
                    int t_block_cols_num>\
        class EIGENUT_VISIBILITY_ATTRIBUTE class_name : public BlockMatrix<t_block_rows_num, t_block_cols_num, sparsity_type> \
        {\
            public:\
     ...
     * @tparam t_block_cols_num number of columns in one block
     */
    EIGENUT_CODE_GENERATOR(GenericBlockMatrix, MatrixSparsityType::NONE)
    /// @copydoc GenericBlockMatrix
    EIGENUT_CODE_GENERATOR(DiagonalBlockMatrix, MatrixSparsityType::DIAGONAL)
    /// @copydoc GenericBlockMatrix
    EIGENUT_CODE_GENERATOR(LeftLowerTriangularBlockMatrix, MatrixSparsityType::LEFT_LOWER_TRIANGULAR)
#undef EIGENUT_CODE_GENERATOR
