...
#ifndef H_EIGENUT_CROSS_PRODUCT
#define H_EIGENUT_CROSS_PRODUCT
...
namespace eigenut
{
    ...
    class CrossProductMatrix
    {
        ...
        public:
             ...
             */
            explicit CrossProductMatrix(const eigenut::Vector3 &vector) : vector_(vector)
            {
            }
             ...
             */
            static eigenut::Matrix3 eval(const eigenut::Vector3 &vector)
            {
                return (   (eigenut::Matrix3() <<    0.0,            -vector.z(),    vector.y(),
    ...
    template<class t_Derived>
        Eigen::Matrix<  eigenut::DefaultScalar,
